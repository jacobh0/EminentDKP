...
L["Awardees"] = "Awardees"
L["Events missed by"] = "Events missed by"
...
L["Attendance Period"] = "Attendance Period"
L["The number of days prior to today to use when measuring attendance."] = "The number of days prior to today to use when measuring attendance."
...
L["Guild Group"] = "Guild Group"
L["Only allow EminentDKP to function inside of a guild group."] = "Only allow EminentDKP to function inside of a guild group."
L["Disable PVP"] = "Disable PVP"
L["Do not allow EminentDKP to function during PVP."] = "Do not allow EminentDKP to function during PVP."
L["Disable Party"] = "Disable Party"
L["Do not allow EminentDKP to function in a party."] = "Do not allow EminentDKP to function in a party."
...
L["has been acquired for %d DKP"] = "has been acquired for %d DKP"
L["You have been awarded"] = "You have been awarded"
...
L["An auction is already active."] = "An auction is already active."
L["You cannot transfer DKP during an auction."] = "You cannot transfer DKP during an auction."
...
L["Last Seen: %d day(s) ago."] = "Last Seen: %d day(s) ago."

L["Available Commands:"] = "Available Commands:"
L["Check your current balance"] = "Check your current balance"
L["Check the current balance of player X"] = "Check the current balance of player X"
L["Display the current dkp standings"] = "Display the current dkp standings"
L["Display the lifetime earned dkp standings"] = "Display the lifetime earned dkp standings"
L["Place a bid of X DKP on the active auction"] = "Place a bid of X DKP on the active auction"
L["Transfer X DKP to player Y"] = "Transfer X DKP to player Y"
L["These commands can only be sent to the master looter while in a group"] = "These commands can only be sent to the master looter while in a group"
