...
L["These commands can only be sent to the master looter and only during a raid"] = "These commands can only be sent to the master looter and only during a raid"
